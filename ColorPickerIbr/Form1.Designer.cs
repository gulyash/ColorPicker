namespace ColorPickerIbr
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.checkBoxBlue.CheckedChanged += new System.EventHandler(this.checkBox_CheckedChanged);
			// 
			// flowLayoutPanel1
			// 
			...
			this.radioButtonYellow.CheckedChanged += new System.EventHandler(this.radioButton_CheckedChanged);
			// 
			// radioButtonBlue
			// 
			...
			this.radioButtonMagenta.CheckedChanged += new System.EventHandler(this.radioButton_CheckedChanged);
			// 
			// radioButtonCyan
			// 
			...
			this.radioButtonCyan.CheckedChanged += new System.EventHandler(this.radioButton_CheckedChanged);
			// 
			// radioButtonWhite
			// 
			...
			this.radioButtonWhite.CheckedChanged += new System.EventHandler(this.radioButton_CheckedChanged);
			// 
			// Form1
			// 
